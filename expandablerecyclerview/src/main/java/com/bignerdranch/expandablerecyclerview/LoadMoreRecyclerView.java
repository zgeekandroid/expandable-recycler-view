...
//    private boolean mIsFooterEnable = false;//是否允许加载更多
     ...
     */
    private ExpandableRecyclerAdapter mAutoLoadAdapter;
    /**
    ...
    private void init() {
        super.addOnScrollListener(new OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (null != mListener && ismIsFooterEnable() && !mIsLoadingMore && dy > 0) {
...
//        super.swapAdapter(mAutoLoadAdapter, true);
        this.mAutoLoadAdapter = (ExpandableRecyclerAdapter) adapter;
...
//        super.swapAdapter(mAutoLoadAdapter, true);
    ...
    public void setAutoLoadMoreEnable(boolean autoLoadMore) {
        ...
        mAutoLoadAdapter.setFooterEnable(autoLoadMore);

    }

    public boolean ismIsFooterEnable() {
        if (mAutoLoadAdapter != null)
        return mAutoLoadAdapter.getFootEnable();
        return false;
    }
