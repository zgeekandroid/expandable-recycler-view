...
public class ParentViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private boolean mCompatibleXRecylerView;//是否兼容XRecylerView
    ...
    protected void expandView() {
        ...
        if (mParentListItemExpandCollapseListener != null) {
            mParentListItemExpandCollapseListener.onParentListItemExpanded(mCompatibleXRecylerView ?getAdapterPosition() - 1 :getAdapterPosition());
        }
    }
    ...
    protected void collapseView() {
        ...
        if (mParentListItemExpandCollapseListener != null) {
            mParentListItemExpandCollapseListener.onParentListItemCollapsed(mCompatibleXRecylerView ?getAdapterPosition() - 1 :getAdapterPosition());
        }
    }


    protected  boolean isCompatibleXRecylerView(){
        return mCompatibleXRecylerView;
    }

    public void setmCompatibleXRecylerView(boolean mCompatibleXRecylerView) {
        this.mCompatibleXRecylerView = mCompatibleXRecylerView;
    }
}
