...
public class ExpandableRecyclerAdapterHelper {
    ...
    public static List<? extends ParentListItem> addParentItemList(List<? extends ParentListItem> oldParentItemList, List<? extends ParentListItem> parentItemList) {
        List<ParentListItem> tmpList = new ArrayList<>();
        if (oldParentItemList != null) {
            for (ParentListItem temp : oldParentItemList) {
                tmpList.add(temp);
            }
        }
        if (parentItemList != null) {
            for (ParentListItem temp : parentItemList) {
                tmpList.add(temp);
            }
        }
